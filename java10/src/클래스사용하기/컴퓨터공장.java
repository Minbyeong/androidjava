...
public class 컴퓨터공장 {
	...
	public static void main(String[] args) {
		...
		// import로 경로를 명시해줘야 한다.
		// 자동import: 1)자동완성 2)마우스를 올리고 선택 3)컨트롤+쉬프트+o(영문)
		컴퓨터 com1 = new 컴퓨터();
		// com1은 주소가 들어감. 주소로 가르키는 변수는 3개
		// public은 접근제어자(default, public)
		// => 다른 패키지에 있는 변수를 사용하기 위해선 변수 앞에 public이 있어야 사용 가능
		...
		System.out.println("com1의 모니터 사이즈는 " + com1.size);
		...
		System.out.println("com2의 모니터 사이즈는 " + com2.size);
	}
