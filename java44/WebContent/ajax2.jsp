	...
	$(function() {
	      $('#b1').click(function() {
	       ...
	       $('#b3').click(function() {
	           $('#d1').empty()
	           $.ajax({
	              url: "https://api.rss2json.com/v1/api.json?rss_url=http%3A%2F%2Fart.chosun.com%2Fsite%2Fdata%2Frss%2Frss.xml&api_key=birzmqkxbv4gksrwjrabcyfzto4pzr686bugehbu",
	              data:{
