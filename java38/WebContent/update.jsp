...
<body>
	...
	<form action="update2.jsp">
		<table>
			<tr align="center">
				...
				<td width="200" bgcolor="pink"><%=vo.getId()%><input type="hidden" name="id"
					value="<%=vo.getId()%>"></td>
			</tr>
			<tr align="center">
	...
	|
	<a href="one.jsp?id=<%=vo.getId()%>"><button
			style="background: gold">검색</button></a> |
	<a href="delete.jsp?id=<%=vo.getId()%>"><button
			style="background: lime">삭제</button></a> ]
